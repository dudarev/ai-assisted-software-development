...
Related tweet:
https://x.com/alexhillman/status/2009812900802900274
one of the wildest part of my workflow now is using my phone to talk to my assistant hosted on a VM in the cloud about features I want to add to my mac app so the assistant SSHs into my mac mini at home to run swift builds and sends me screenshots to verify visual changes. 🤯
